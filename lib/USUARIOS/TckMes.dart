...
class _TckMesState extends State<TckMes> {
      ...
      if (response.statusCode == 200) {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            final ventas = data[
                'venta']; // Obtener todos los elementos de la lista 'venta'
            return AlertDialog(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            textAlign: TextAlign
                                .center, // Alinea el texto a la derecha
                          ),
                        ),
                        Expanded(
                          child: Text(
                    ...
                    ...ventas.map((venta) {
                      return Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                              height:
                                  5), // Espaciado entre la descripción y los detalles
  ...
  Widget _buildVentasList() {
    if (ventas.isEmpty) {
      ...
      return Column(
        children: [
                              SizedBox(height: 50), // Espaciado adicional
    ...
    body: Stack(
      children: [
        ...
        // Aquí agregamos el FloatingBubble
          // FloatingBubble se coloca fuera de la jerarquía normal de widgets
          Positioned(
            bottom: 20,
            right: 20,
            child: FloatingBubble(id: widget.id),
          ),
      ],
    ),
