...
import 'tickets_page0.dart';
import 'new_ticket_page0.dart';
        ...
        child: Center(
          child: Column(
            mainAxisSize: MainAxisSize
                .min, // Cambia el tamaño del eje principal para ajustarse al contenido
            children: [
              Padding(
                        ...
                        return Container(
                          ...
                          child: NewTicketPage(
                            onTicketRegistered: (ticket) {
                              ...
                              print(ticket);
                              Navigator.pop(
                                  context); // Cierra el modal después de registrar el ticket
                            },
